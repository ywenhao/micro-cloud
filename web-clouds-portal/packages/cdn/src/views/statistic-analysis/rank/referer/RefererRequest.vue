...
import { getCdnStatisticTopRefererRequestListApi } from '@vcp/apis/cdn'
...
const columns: TableColumnData[] = [
  ...
  { dataIndex: 'request', title: '请求数', width: 200 }
]
...
const {
  ...
  run: getTableList,
  data: dataSource
} = useListRequest(getCdnStatisticTopRefererRequestListApi, state, {
  showPageSize: false,
  pageSize: 5
})
