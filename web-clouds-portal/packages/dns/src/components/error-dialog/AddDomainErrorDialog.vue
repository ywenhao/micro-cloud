  ...
  >
    <div class="w-full">
      <a-alert class="mb-4" closable
        >因域名错误、重复等原因，有域名及记录未成功添加</a-alert
      >
      <div class="custom-table">
        <div class="t-head">
          <div class="t-item">成功添加域名</div>
          <div class="t-item">成功添加记录</div>
          <div class="t-item">未成功添加域名</div>
        </div>
        <div class="t-body">
          <div class="t-item">{{ state.success_count }}个</div>
          <div class="t-item">{{ state.success_rr_count }}条</div>
          <div class="t-item">{{ state.fail_domains.length }}个</div>
        </div>
      </div>
