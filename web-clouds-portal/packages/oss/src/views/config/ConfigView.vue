    ...
    >
      <a-form-item hide-asterisk label="证书品牌">
        ...
        >
          ...
          <div v-if="formState.brand.length === 2" class="flex flex-col mt-4">
            <span>优先使用</span>
...
import { getSystemConfigApi, saveSystemConfigApi } from '@vcp/apis/src/ssl'
