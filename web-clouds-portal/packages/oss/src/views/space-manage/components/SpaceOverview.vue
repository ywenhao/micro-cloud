...
import { type SpaceBasicModel, spaceViewApi } from '@vcp/apis/oss'
...
const getSpaceView = () => {
  ...
  const { id, region_id } = spaceDetail.value
  spaceViewApi({
    bucket_id: id,
    region_id: region_id,
    start: String(start),
