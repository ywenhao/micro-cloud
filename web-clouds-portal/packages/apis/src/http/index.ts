...
import { getToken } from '@vcp/shared'
import { useUserAgent } from '@vcp/shared/hooks/useUserAgent'
...
const createTransform = (apisInstance: Apis): AxiosTransform => ({
  ...
  transformResponseHook: (
    ...
    if (options.errorMessageMode === 'notification') {
      Notification.error({ title: '错误提示', content: errorMsg })
 ...
 * 单例模式Apis
 */
export const singleApis = singleton(Apis)
