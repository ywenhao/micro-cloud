...
/** 修改站点基础信息(管理员操作=>站点区域、限速) */
export const updateCdnSiteBasicByIdApi: CommonAPI<
  '/v1/cdn/site/basic/{site_id}',
  'put'
> = data => defHttp.put(`/v1/cdn/site/basic/${data.site_id}`, { data })
...
export const getCdnSiteOriginConfigByIdApi: CommonAPI<
  ...
  'get'
> = params => defHttp.get(`/v1/cdn/site/origin-config/${params.site_id}`)
...
export const getCdnSiteSslConfigByIdApi: CommonAPI<
  ...
  'get'
> = params => defHttp.get(`/v1/cdn/site/ssl-config/${params.site_id}`)
...
/** 修改站点状态(管理员操作站点状态) */
export const updateCdnSiteStatusByIdApi: CommonAPI<
  '/v1/cdn/site/status/{site_id}',
  'put'
> = data => defHttp.put(`/v1/cdn/site/status/${data.site_id}`, { data })
...
export const updateCdnSiteWafRuleByIdApi: CommonAPI<
  ...
  'put'
> = data =>
  defHttp.put(`/v1/cdn/site/waf-rule/${data.site_id}/${data.rule_id}`, {
    data
  })
...
export const getCdnSiteDetailByIdApi: CommonAPI<
  '/v1/cdn/site/{site_id}',
  'get'
> = params => defHttp.get(`/v1/cdn/site/${params.site_id}`)
