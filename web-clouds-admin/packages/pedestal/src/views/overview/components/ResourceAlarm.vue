...
import { type AlarmModel, getAlarmApi } from '@vca/apis/pedestal'

import AramDetailDialog from './AramDetailDialog.vue'
...
const detailState = reactive({
  visible: false,
  record: undefined as undefined | AlarmModel,
  title: ''
})

const handleDetail = (item: AlarmModel) => {
  detailState.visible = true
  detailState.title = getProductText(item)
  detailState.record = item
}
