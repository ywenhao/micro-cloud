...
import { editCycleApi, lifeCycleApi, type LifeCycleModel } from '@vca/apis/oss'
import { cloneDeep } from 'lodash-es'
import { VcModal } from 'vc-material'
import { useRoute } from 'vue-router'

import { lifeColumns } from '../columns'
import LifeRule from './LifeRule.vue'

const route = useRoute()
const loading = ref<boolean>(false)

const dataSource = ref<LifeCycleModel[] | undefined>([])
const pageList = ref<LifeCycleModel[] | undefined>([])
const pageData = ref({
  pageSize: 5,
  currentPage: 1,
  total: 0
