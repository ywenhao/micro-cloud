      ...
      <a-form-item field="name" label="" class="mb-8!">
        ...
        <div class="file-detail-table flex-1">
          ...
          <a-row
            ...
            :key="index"
            class="file-detail-row pb-2"
          >
            <a-col :span="10" :class="!item.edit ? '' : 'pt-2'">
              <span v-if="item.edit">{{ item.label }}</span>
              <a-form-item
                v-else
            ...
            <a-col
              :span="4"
              class="pl-2! pt-2 flex items-center gap-x-4"
...
.file-detail-table {
  ...
  .file-detail-header {
    @apply flex h-10 leading-10 font-medium w-full bg-[#F2F3F5];
  ...
  .add-file-btn {
    @apply h-10 leading-10 flex items-center justify-center;
  }
}
</style>
