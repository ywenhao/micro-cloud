...
import { licenseDetailsApi } from '@vca/apis/src/ssl'
import dayjs from 'dayjs'

import { algorithmOptions, statusOwnedOptions, verifyOptions } from '@/config'
...
const restTime = computed(() => {
  const date1 = dayjs.unix((Number(formState.value?.expiration_time) ?? 0) + 60)
